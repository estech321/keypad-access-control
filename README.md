...
## Disclaimers
 ...
 - PIN codes and RFID UIDs are stored in encrypted JSON data on the Pico's local storage with a key generated by `machine.unique_id()`. This makes it harder to find the PINs and RFID UIDs, but **not impossible**, as anyone with USB access to the Pico could bypass everything or derive your information.
